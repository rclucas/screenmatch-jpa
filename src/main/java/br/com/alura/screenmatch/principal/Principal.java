...
//        dadosSeries.add(dados);
    ...
    private void buscarSeriePorTitulo() {
        ...
        var nomeSerie = leitura.nextLine();
        Optional<Serie> serieBuscaca = repository.findByTituloContainingIgnoreCase(nomeSerie);
        if(serieBuscaca.isPresent()) {
            System.out.println("Dados da Série:" + serieBuscaca.get());
        }else {
